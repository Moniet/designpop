...
const Pricing = () => {
  ...
  return (
    <div className="flex flex-col" id="pricing">
      ...
      <div className="w-full max-w-[600px] mx-auto rounded-[30px] bg-[#f9f9f9] border border-[#e8e8e8] p-3 mt-20 pb-20">
            ...
            <AnimatePresence mode="popLayout">
              ...
              >
                <div className="text-right text-zinc-500 font-semibold">
                  {selected === 2 ? "Ideal for ongoing" : "Done in"}
                </div>
                <div className="flex items-center font-semibold">
                  <BiStopwatch
                    className={`size-4 mr-1 text-zinc-500 -mb-[1px] ${
                      selected === 2 ? "hidden" : "inline-block"
                    }`}
                    stroke="3"
                  />
                  <span className="text-zinc-900 whitespace-nowrap">
                    {selected === 2 ? "long term work" : data.timeline}
                  </span>
                </div>
              </motion.div>
            </AnimatePresence>
