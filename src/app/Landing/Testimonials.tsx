...
const TestimonialCard = ({ isActive, ...props }: TestimonialCardProps) => {
  return (
    <motion.div
      ...
      // exit={"exit"}
      className={`md:px-10 md:py-8 py-5 px-8 transition-colors rounded-[15px] border border-[#e8e8e8] flex flex-col-reverse gap-24 flex-1 justify-between min-w-[300px] max-w-[300px] w-full sm:min-w-[500px] sm:max-w-[500px] lg:min-w-[600px] lg:max-w-[600px] ${
        isActive
    ...
    <>
      <div className="flex w-full max-md:flex-col justify-between">
        ...
        <motion.div
          ...
          // viewport={{ once: true }}
          className="text-zinc-900 font-semibold  min-[300px]:text-2xl min-[390px]:text-3xl sm:text-4xl xl:text-5xl leading-12 md:pb-2 sm:hidden max-sm:mb-10 max-sm:mt-20"
        >
      ...
      >
        ...
        <motion.div
          data-component="testimonials"
          className="absolute top-0 left-0 pointer-events-none max-lg:hidden portrait:hidden"
          style={{
            x: posX,
            y: posY,
